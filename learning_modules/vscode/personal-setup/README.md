...
> Note: The ```.``` is an alias that refers to the current directory. If you want to learn why we need to use ```./``` to run executables, then <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/questions/6331075/why-do-you-need-dot-slash-before-executable-or-script-name-to-run-it-in-bas">this StackOverflow post</a> provides a good explanation.
